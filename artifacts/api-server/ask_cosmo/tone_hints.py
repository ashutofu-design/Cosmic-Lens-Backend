...
`reply_cosmo/tone_hints.py` because tone-hints are a RESPONSE-SHAPING
...
work. New code should import from `reply_cosmo` instead.
...
History (preserved for grep traceability):
  ...
  - Phase 2.8.49: relocated to `reply_cosmo/tone_hints.py`; this file
