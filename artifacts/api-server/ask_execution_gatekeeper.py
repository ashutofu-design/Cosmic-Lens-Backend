...
def check_final_answer_gate(
    ...
    *,
    ...
    if (
        str(meta.get("slice") or "").strip() == "travel_engine_v1"
        and (
            _mr_checks.get("unified_execution")
            or _mr_checks.get("travel_engine_execution")
            or str(_mr_checks.get("engine_version") or "") == "travel_engine_execution_v1"
        )
    ):
        return GatekeeperResult(True, "final", "exempt", "travel_unified_execution")
...
def run_post_engine_gate(
    ...
    *,
    ...
    if (
        ...
        return GatekeeperResult(True, "engine", "exempt", "travel_unified_execution")
