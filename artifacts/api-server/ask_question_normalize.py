...
_WORD_FIXES: list[tuple[re.Pattern[str], str]] = [
    ...
    (re.compile(r"\bgem\s*stoene\b", re.I), "gemstone"),
    (re.compile(r"\bgem\s*stone\b", re.I), "gemstone"),
    (re.compile(r"\bgemston+\b", re.I), "gemstone"),
    (re.compile(r"\bratan+\b", re.I), "ratna"),
    (re.compile(r"\bdharan+\b", re.I), "dharan"),
    (re.compile(r"\bleo\b", re.I), "leo"),
