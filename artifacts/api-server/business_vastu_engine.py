...
BUSINESS_CRITICAL: Dict[str, Dict[str, Dict[str, List[str]]]] = {
    "shop": {
        ...
        "billing_counter":{"ideal": ["N", "NE", "E"],    "avoid": ["S", "SW"]},
        "vault":         {"ideal": ["N", "NE"],         "avoid": ["S", "SW"]},
        "stock_storage": {"ideal": ["SW", "W", "S"],    "avoid": ["NE"]},
        "display":       {"ideal": ["E", "N", "NE"],    "avoid": ["SW"]},
        "pooja":         {"ideal": ["NE", "E", "N"],    "avoid": ["SW", "S", "SE"]},
        "back_office":   {"ideal": ["SW", "S", "W"],    "avoid": ["NE", "N"]},
        "staff_room":    {"ideal": ["NW", "W", "N"],    "avoid": ["NE", "SE"]},
        "toilet":        {"ideal": ["NW", "W"],         "avoid": ["NE", "E"]},
    },
    "office": {
        "entrance":       {"ideal": ["N", "NE", "E"],  "avoid": ["SW", "S"]},
