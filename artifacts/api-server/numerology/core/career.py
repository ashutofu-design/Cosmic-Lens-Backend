...
DRIVER_VOCATION: Dict[int, Dict[str, Any]] = {
    ...
    7: {
        "planet": "Ketu", "vibration": "Analysis / Research / Deep-work",
        "keywords": ["research & investigation", "data analytics",
                     "remote / independent work", "specialist IT / niche tech",
                     "academic writing", "psychology & therapy"],
        "execution_style": "introspective, focused, slow-burn",
        "best_role": "researcher, analyst, specialist consultant, niche IT expert, deep-work writer",
...
def _synergy(driver: int, conductor: int) -> str:
    ...
    try:
        from numerology.core.framing import _synergy_verdict
