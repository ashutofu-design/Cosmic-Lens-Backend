...
_PT_SYS_INTRO = (
    ...
    "\n"
    "3. SHORT RAKHO — max 3-4 bullets per detailed answer. Mobile "
    ...
    "\n"
    "4. FOCUS — sirf question-relevant houses/planets cite karo. "
