...
_PROMPT_TEMPLATE = (
    ...
    "comparison questions, AND conditional / implication questions of the "
    "form 'X hai to Y ho jayega?', 'Agar A hai to B hoga?', 'X strong hai "
    "to Y automatically strong?' (even when a graha is named in the "
    "condition — the QUESTION is about the implication, not the planet "
    "status). Fallback when none of the above fits.\n\n"
