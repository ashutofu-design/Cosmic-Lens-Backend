...
_EMOTION_TONE_HINT_HN = {
    "anxiety": (
        ...
        [
            ...
            "Dekho, ghabrane se rasta nahi dikhta - chaliye saath dekhte hain.",
            "Suniye ek baat - ye dar sirf abhi ka phase hai, permanent nahi.",
            "Jo main dekh raha hoon kundli me, woh utna heavy nahi jitna lag raha.",
            "Straight baat bolu - ye unease shift hota hai, rukti nahi.",
        ],
    ),
    "frustration": (
        ...
        [
            ...
            "Dekho, aapka frustration valid hai - situation hi aisi hai.",
            "Suniye, jo wait aap kar rahe ho woh genuinely bharee hai.",
            "Jo main dekh raha hoon - ye thakaan natural hai is jagah pe.",
            "Straight baat bolu - ye phase ek-ek din heavy lagta hai.",
        ],
    ),
    "sadness": (
        ...
        [
            ...
            "Dekho, ye dor heavy hai - aap akele nahi hain isme.",
            "Suniye, kuch baatein samay maangti hain - ye wahi phase hai.",
            "Jo main dekh raha hoon - ye guzar jayega, sath chaliye.",
            "Straight baat bolu - ye udaasi ka pattern bhi shift hota hai.",
        ],
    ),
    "anger": (
        ...
        [
            ...
            "Dekho, gussa aana sahi hai - situation hi trigger karti hai.",
            "Suniye, aapki frustration ka cause real hai - ignore nahi kar raha.",
            "Jo main dekh raha hoon - ye reaction natural hai is phase me.",
            "Straight baat bolu - jo ho raha hai woh chidana wala hai sach me.",
        ],
    ),
    "confusion": (
        ...
        [
            ...
            "Dekho, ek-ek karke todhte hain ye baat.",
            "Suniye, ek baat ek time - saaf ho jayega.",
            "Jo main dekh raha hoon - aap right track pe ho, bas thoda untangle karna hai.",
            "Straight baat bolu - ye uljhan natural hai is jagah pe.",
        ],
    ),
}
