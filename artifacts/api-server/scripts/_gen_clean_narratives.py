"""One-off generator for clean psychology-only narratives.py."""
from __future__ import annotations

from pathlib import Path
from textwrap import dedent

OUT = Path(__file__).resolve().parents[1] / "numerology" / "core" / "narratives.py"
...
Deep, story-style content per driver number (1-9):
  ...
  health_pattern, spiritual_path (life-direction psychology),
...
# Shared lists reused across languages where identical
SHARED = {
    1: {
        "strengths": ["Vision", "Fast decisions", "Natural magnetism", "Original thinking", "Calm in crisis"],
        "challenges": ["Ego vs authority", "Loneliness at top", "Impatience", "Overruling advice", "Thin skin to criticism"],
        "risk_alerts": [
    ...
    2: {
        "strengths": ["Empathy", "Diplomacy", "Adaptability", "Aesthetic sense", "Patience in long games"],
        "challenges": ["Mood swings", "Over-giving", "Avoiding confrontation", "Indecision under pressure", "Emotional spending"],
        "risk_alerts": [
    ...
    3: {
        "strengths": ["Teaching clarity", "Optimism", "Creative framing", "Generosity", "Long-range planning"],
        "challenges": ["Overconfidence in advice", "Weak follow-through", "Weight gain when sedentary", "Unsolicited lecturing", "Over-invested in students"],
        "risk_alerts": [
    ...
    4: {
        "strengths": ["Original thinking", "Tech adoption", "Crisis innovation", "Diverse network", "Systems mindset"],
        "challenges": ["Restlessness", "Screen/addiction risk", "Sudden anger spikes", "Relationship boredom", "Get-rich-quick temptation"],
        "risk_alerts": [
    ...
    5: {
        "strengths": ["Multitasking", "Networking", "Adaptability", "Negotiation", "Fast learning"],
        "challenges": ["Shallow mastery", "Anxiety/restlessness", "Commitment phobia", "Sarcasm under stress", "Over-promising"],
        "risk_alerts": [
    ...
    6: {
        "strengths": ["Aesthetic sense", "Relationship maintenance", "Diplomacy", "Generosity", "First-meeting charm"],
        "challenges": ["Luxury overspend", "Weak boundaries with family", "Conflict avoidance", "Vanity pressure", "Comfort-zone trap"],
        "risk_alerts": [
    ...
    7: {
        "strengths": ["Deep research", "Intuition", "Self-sufficiency", "Unbiased judgment", "Pattern recognition"],
        "challenges": ["Isolation risk", "Practical-world friction", "Intimacy distance", "Late commitment", "Cynicism"],
        "risk_alerts": [
    ...
    8: {
        "strengths": ["Discipline", "Endurance", "Strategic mind", "Loyalty", "Justice orientation"],
        "challenges": ["Perceived coldness", "Pessimism spells", "Slow early progress", "Workaholism", "Authority friction"],
        "risk_alerts": [
    ...
    9: {
        "strengths": ["Courage", "High energy", "Passion", "Protective instinct", "Initiative"],
        "challenges": ["Anger management", "Impulsivity", "Jealousy", "Injury risk", "Authority clashes"],
        "risk_alerts": [
...
PACKS = {
    1: {
        ...
        "tag_hg": "Aap lead karne ke liye wired ho — apne tareeke se.",
        "tag_en": "You are wired to lead — on your own terms.",
        "essence_hg": [
        ...
        "money_hg": "Variable pay, business, equity suit karta hai. 6-month buffer + auto-invest; impulse par 24-hour rule.",
        "money_en": "Variable pay, business, and equity suit you. Six-month buffer plus auto-invest; 24-hour rule on impulse.",
        "health_hg": "Sleep, BP, eyes, back protect karo. Morning movement + post-meeting decompression.",
        "health_en": "Protect sleep, blood pressure, eyes, and back. Morning movement plus post-meeting decompression.",
        "path_hg": "Direction: mentor-by-example. Weekly review — clarity di ya control?",
        "path_en": "Direction: mentor by example. Weekly review — did you offer clarity or control?",
        "golden_hg": "Personal Year 1, 5, 9 = launch energy. Q2 often strongest for new starts.",
        "golden_en": "Personal Years 1, 5, 9 = launch energy. Q2 is often strongest for new starts.",
    },
    2: {
        "title": "Number 2 — Emotional Intelligence Pattern",
        "tag_hg": "Aap log padhkar unhe safe feel karate ho.",
        "tag_en": "You read people and make them feel safe.",
        "essence_hg": [
        ...
        "money_hg": "Tidal cash flow — forced SIP + 6-month emergency fund emotional security deta hai.",
        "money_en": "Tidal cash flow — forced SIP plus six-month emergency fund gives emotional security.",
        "health_hg": "Sleep, stomach, lungs — late nights avoid. Hydration + gentle movement.",
        "health_en": "Sleep, stomach, lungs — avoid late nights. Hydration plus gentle movement.",
        "path_hg": "Direction: emotional translator — help others name feelings, apni bhi name karo.",
        "path_en": "Direction: emotional translator — help others name feelings; name yours too.",
        "golden_hg": "Personal Year 2, 4, 6, 8 — partnership aur stability themes.",
        "golden_en": "Personal Years 2, 4, 6, 8 — partnership and stability themes.",
    },
    3: {
        "title": "Number 3 — Creative Expression Pattern",
        "tag_hg": "Aap ideas ko words, deals, aur impact me convert karte ho.",
        "tag_en": "You turn ideas into words, deals, and impact.",
        "essence_hg": [
        ...
        "money_hg": "Knowledge monetization — coaching, courses, writing. Diversify; one salary trap.",
        "money_en": "Monetize knowledge — coaching, courses, writing. Diversify; one salary is a trap.",
        "health_hg": "Liver, metabolism, hips — sweets limit; walk after meals.",
        "health_en": "Liver, metabolism, hips — limit sweets; walk after meals.",
        "path_hg": "Direction: wisdom-sharing with accountability — learn publicly, iterate openly.",
        "path_en": "Direction: wisdom-sharing with accountability — learn publicly, iterate openly.",
        "golden_hg": "Personal Year 3, 6, 9 — expression aur income link strong.",
        "golden_en": "Personal Years 3, 6, 9 — expression and income link strongly.",
    },
    4: {
        "title": "Number 4 — Structure & Discipline Pattern",
        "tag_hg": "Aap systems tod kar better systems banate ho.",
        "tag_en": "You break systems to build better ones.",
        "essence_hg": [
        ...
        "money_hg": "Wave income — 70% safe assets, 30% speculative max. Document everything.",
        "money_en": "Wave income — 70% safe assets, 30% speculative max. Document everything.",
        "health_hg": "Skin, nerves, sleep — meditation + phone curfew 1hr before bed.",
        "health_en": "Skin, nerves, sleep — meditation plus phone curfew one hour before bed.",
        "path_hg": "Direction: constructive disruption — upgrade broken processes, not people.",
        "path_en": "Direction: constructive disruption — upgrade broken processes, not people.",
        "golden_hg": "Personal Year 1, 4, 7 — innovation sprint months.",
        "golden_en": "Personal Years 1, 4, 7 — innovation sprint months.",
    },
    5: {
        "title": "Number 5 — Adaptability & Movement Pattern",
        "tag_hg": "Aap deals, ideas, aur logon ko jodne me fastest ho.",
        "tag_en": "You are fastest at connecting deals, ideas, and people.",
        "essence_hg": [
        ...
        "money_hg": "Multiple streams mandatory — side hustle + diversified investments.",
        "money_en": "Multiple streams are mandatory — side hustle plus diversified investments.",
        "health_hg": "Anxiety, IBS, skin — no multitask while eating; daily breathwork.",
        "health_en": "Anxiety, IBS, skin — no multitasking while eating; daily breathwork.",
        "path_hg": "Direction: connector-curator — bridge people, protect your focus blocks.",
        "path_en": "Direction: connector-curator — bridge people, protect your focus blocks.",
        "golden_hg": "Personal Year 5 — change aur opportunity peak.",
        "golden_en": "Personal Year 5 — peak change and opportunity.",
    },
    6: {
        "title": "Number 6 — Responsibility & Harmony Pattern",
        "tag_hg": "Aap relationships aur environment ko beautiful banate ho.",
        "tag_en": "You make relationships and environments beautiful.",
        "essence_hg": [
        ...
        "money_hg": "Money via relationships, design, service — luxury OK if income ratio disciplined.",
        "money_en": "Money via relationships, design, service — luxury OK if income ratio is disciplined.",
        "health_hg": "Kidneys, throat, skin mirror stress — hydration, boundaries, sleep.",
        "health_en": "Kidneys, throat, skin mirror stress — hydration, boundaries, sleep.",
        "path_hg": "Direction: beautify responsibility — care with boundaries, art with budget.",
        "path_en": "Direction: beautify responsibility — care with boundaries, art with budget.",
        "golden_hg": "Personal Year 6 — home, love, creative projects peak.",
        "golden_en": "Personal Year 6 — home, love, creative projects peak.",
    },
    7: {
        "title": "Number 7 — Analysis & Depth Pattern",
        "tag_hg": "Aap depth me jaakar truth dhundhte ho — quietly.",
        "tag_en": "You seek truth in depth — quietly.",
        "essence_hg": [
        ...
        "money_hg": "Knowledge income — writing, consulting, research. Auto-SIP kyunki planning weak ho sakti hai.",
        "money_en": "Knowledge income — writing, consulting, research. Auto-SIP because planning can be weak.",
        "health_hg": "Nerves, immunity, digestion — routine sleep, nature walks, limit stimulants.",
        "health_en": "Nerves, immunity, digestion — routine sleep, nature walks, limit stimulants.",
        "path_hg": "Direction: inner clarity for outer decisions — journal, retreat, then act.",
        "path_en": "Direction: inner clarity for outer decisions — journal, retreat, then act.",
        "golden_hg": "Personal Year 7 — study, solo projects, insight breakthroughs.",
        "golden_en": "Personal Year 7 — study, solo projects, insight breakthroughs.",
    },
    8: {
        "title": "Number 8 — Accountability & Scale Pattern",
        "tag_hg": "Aap long game khelte ho — slow build, big scale.",
        "tag_en": "You play the long game — slow build, big scale.",
        "essence_hg": [
        ...
        "money_hg": "Slow compound wealth — real assets, index funds, avoid speculative debt.",
        "money_en": "Slow compound wealth — real assets, index funds, avoid speculative debt.",
        "health_hg": "Joints, knees, teeth, mood — walking, strength training, therapy OK.",
        "health_en": "Joints, knees, teeth, mood — walking, strength training, therapy is OK.",
        "path_hg": "Direction: scale with integrity — power ko service se balance karo.",
        "path_en": "Direction: scale with integrity — balance power with service.",
        "golden_hg": "Personal Year 8 — contracts, promotions, asset moves.",
        "golden_en": "Personal Year 8 — contracts, promotions, asset moves.",
    },
    9: {
        "title": "Number 9 — Completion & Impact Pattern",
        "tag_hg": "Aap passion ke liye fight karte ho — energy high, impact driven.",
        "tag_en": "You fight for passion — high energy, impact driven.",
        "essence_hg": [
        ...
        "money_hg": "Earn via effort + risk roles — diversify; anger se financial decisions mat lo.",
        "money_en": "Earn via effort and risk roles — diversify; do not decide finances in anger.",
        "health_hg": "Blood, muscles, head — sport safety, annual labs, spice moderation.",
        "health_en": "Blood, muscles, head — sport safety, annual labs, spice moderation.",
        "path_hg": "Direction: fight for causes, not egos — mission > argument.",
        "path_en": "Direction: fight for causes, not egos — mission over argument.",
        "golden_hg": "Personal Year 9 — completion, release, next-cycle prep.",
        "golden_en": "Personal Year 9 — completion, release, next-cycle prep.",
    },
}


def build_table(lang_key: str) -> str:
    lines = []
    for n in range(1, 10):
        p = PACKS[n]
        s = SHARED[n]
        prefix = {"hg": "", "en": "_EN"}[lang_key.split("_")[-1] if "_" in lang_key else lang_key]
        # fix: lang_key is 'hg' or 'en'
        lk = lang_key
        lines.append(f"    {n}: {{")
        lines.append(f'        "title": "{p["title"]}",')
        lines.append(f'        "tagline": "{p[f"tag_{lk}"]}",')
        for field, key in [
            ("life_essence", f"essence_{lk}"),
            ("career_pattern", f"career_{lk}"),
            ("love_pattern", f"love_{lk}"),
        ]:
            ...
            lines.append("        ],")
        for field, key in [
            ("money_pattern", f"money_{lk}"),
            ("health_pattern", f"health_{lk}"),
            ("spiritual_path", f"path_{lk}"),
            ("golden_periods", f"golden_{lk}"),
        ]:
            lines.append(f'        "{field}": "{p[key]}",')
        for list_name in ("strengths", "challenges", "risk_alerts"):
            lines.append(f'        "{list_name}": [')
            for item in s[list_name]:
                lines.append(f'            "{item}",')
            lines.append("        ],")
        lines.append("    },")
    return "\n".join(lines)
...
body = HEADER + "_NARRATIVES_HG: Dict[int, Dict[str, Any]] = {\n" + build_table("hg") + "\n}\n\n"
body += "_NARRATIVES_EN: Dict[int, Dict[str, Any]] = {\n" + build_table("en") + "\n}\n\n"
body += "_NARRATIVES_HI: Dict[int, Dict[str, Any]] = {}\n"
body += TAIL
