"""Generate a local sample mystic Numerology founder PDF for visual QA."""
...
OUT = ROOT / "_sample_mystic_numerology.pdf"


def main() -> None:
    pdf = render_founder_text_pdf(
        title="Mystic Numerology Report",
        ...
        mystic_theme=True,
        cover_tagline="Your guide to success",
