...
LO_SHU_MEANING = {
    ...
    7:"Luck, sacrifice, spirituality (Metal)",
...
PERSONAL_YEAR_THEME = {
    ...
    7:"INTROSPECTION — study, spirituality, solitude, research",
...
# ────────────────────────────────────────────────────────────────────────────
MASTER_MEANING = {
    11:"Master Intuitive / Spiritual messenger — heightened intuition, "
       "psychic ability, inspirational leader. Higher octave of 2.",
    22:"Master Builder — turns visions into reality on grand scale, "
       "architects, founders. Higher octave of 4.",
    33:"Master Teacher — selfless service, healing, divine love. "
       "Rare; higher octave of 6.",
}
...
KARMIC_MEANING = {
    ...
    14:"Misuse of freedom in past life; learn moderation, adaptability "
       "without indulgence",
    16:"Ego/love-triangle karma; sudden falls from grace — humility "
       "and spiritual transformation required",
...
CHEIRO_COMPOUND = {
    ...
    15:"Magic, occult, eloquence, gift of art — favourable",
    16:"Shattered citadel — accidents, sudden falls — caution",
    17:"Star of Magi — spiritual rise above difficulties — fortunate",
    18:"Bitter quarrels, materialism vs spirit — warning",
    19:"Prince of Heaven — happiness, success, honour — most fortunate",
    20:"Awakening / Judgement — call to action, new purpose",
    21:"Crown of Magi — success, advancement, honour after struggle",
    22:"Master Builder — illusion if unfocused, mastery if focused",
    23:"Royal Star of the Lion — promise of help from superiors",
    ...
    32:"Magical power — like 23 — fortunate if own counsel kept",
