...
EXPRESSION = {
    ...
    11: {
        "english": "MASTER destiny: spiritual messenger. You are meant to inspire, not just speak. Channel higher wisdom into popular forms.",
        "hindi": "मास्टर नियति: आध्यात्मिक संदेशवाहक। आप प्रेरित करने के लिए हैं, केवल बोलने के लिए नहीं। उच्च ज्ञान को लोकप्रिय रूपों में चैनल करें।",
        "hinglish": "MASTER destiny: spiritual messenger. Aap inspire karne ke liye ho, sirf bolne ke liye nahi. Higher wisdom ko popular forms me channel karo.",
    },
    22: {
...
BIRTHDAY = {
    ...
    17: _bday("Business leader with spiritual depth (1+7=8 with 7 flavour).",
              "आध्यात्मिक गहराई वाला व्यावसायिक नेता (1+7=8 में 7 की झलक)।",
              "Business leader with spiritual depth (1+7=8 with 7 flavour)."),
