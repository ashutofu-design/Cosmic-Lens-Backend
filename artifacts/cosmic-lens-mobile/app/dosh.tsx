...
function getDemoDoshList(v: VLang): DoshItem[] {
  if (v === "hi") return [
    ...
    { key:"putra",          name:"Putra Dosh",           name_hindi:"पुत्र दोष",           icon:"👶", status:"Mild",   headline:"हल्का पुत्र दोष (Score 1)",                                  description:"पंचम भाव पर आंशिक पीड़ा (शनि की उपस्थिति)। बृहस्पति बलवान होने से प्रभाव सीमित। नियमित संतान गोपाल साधना और गुरु बल बढ़ाने से शांति। संतान सम्बन्धी विषयों के लिए चिकित्सक से अवश्य परामर्श लें।",            remedies:["संतान गोपाल मंत्र का साप्ताहिक जप","कृष्ण जन्माष्टमी पर बच्चों को मिठाई दान"], planet_note:"Triggers: Saturn in 5th house || Bhanga: Jupiter classically strong in H10 (Putra Karaka shield) || Score=1" },
    ...
    { key:"kendradhipati",  name:"Kendradhipati Dosh",   name_hindi:"केन्द्राधिपति दोष",   icon:"👑", status:"None",   headline:"केन्द्राधिपति दोष नहीं — शुभ ग्रहों की शुभता बरकरार",        description:"कोई भी प्राकृतिक शुभ ग्रह (बृहस्पति/शुक्र/बुध/चंद्र) केंद्र भाव (1/4/7/10) का स्वामी नहीं है। शुभ ग्रहों की पूर्ण शुभता बनी हुई है।", remedies:[], planet_note:"लग्न: वृश्चिक" },
  ];
  if (v === "hn") return [
    ...
    { key:"putra",          name:"Putra Dosh",           name_hindi:"पुत्र दोष",           icon:"👶", status:"Mild",   headline:"Mild Putra Dosh (Score 1)",                                description:"5th house par partial affliction (Saturn ki upasthiti). Jupiter strong hone se prabhav seemit. Regular Santan Gopal sadhana aur Guru bal badhane se shanti. Santaan-related vishayon ke liye medical professional se zaroor consult karein.",     remedies:["Santan Gopal mantra weekly jaap","Krishna Janmashtami par bachchon ko sweets daan"], planet_note:"Triggers: Saturn in 5th house || Bhanga: Jupiter classically strong in H10 (Putra Karaka shield) || Score=1" },
    ...
    { key:"kendradhipati",  name:"Kendradhipati Dosh",   name_hindi:"केन्द्राधिपति दोष",   icon:"👑", status:"None",   headline:"Kendradhipati Dosh nahi — Benefics ki shubhata intact",     description:"Koi bhi natural benefic (Jupiter/Venus/Mercury/Moon) Kendra house (1/4/7/10) ka swami nahi hai. Sabhi benefics apni puri shubhata maintain kar rahe hain.", remedies:[], planet_note:"Lagna: Scorpio" },
  ];
  return [
    ...
    { key:"putra",          name:"Putra Dosh",           name_hindi:"पुत्र दोष",           icon:"👶", status:"Mild",   headline:"Mild Putra Dosh (Score 1)",                                  description:"Partial affliction in the 5th house (Saturn presence) but Jupiter is classically strong, providing the Putra-Karaka shield. Maintain regular Santan-Gopal practice and Jupiter-strengthening rituals. Always consult medical professionals for fertility concerns.", remedies:["Chant Santan Gopal mantra weekly on Wednesdays","Donate sweets to children on Krishna Janmashtami"], planet_note:"Triggers: Saturn in 5th house || Bhanga: Jupiter classically strong in H10 (Putra Karaka shield) || Score=1" },
    ...
    { key:"kendradhipati",  name:"Kendradhipati Dosh",   name_hindi:"केन्द्राधिपति दोष",   icon:"👑", status:"None",   headline:"No Kendradhipati Dosh — Benefics' Auspiciousness Intact",     description:"No natural benefic (Jupiter / Venus / Mercury / Moon) owns a Kendra house (1, 4, 7, 10). All benefics retain their full auspicious nature in this chart.", remedies:[], planet_note:"Lagna: Scorpio" },
  ];
}
