  ...
  return (
    ...
    >
      ...
      <Section title="1. Information We Collect">
        ...
        compatibility reports, Jyotish question/answer history, and saved profiles.</P>
      ...
      <Section title="2. How We Use Your Information">
        ...
        <Bullet>To provide Jyotish-based answers to your questions using only your kundli data — not your identity.</Bullet>
      ...
      <Section title="3. The Service">
        ...
        vastu, lucky elements, and Jyotish-based question answering. Calculations
      ...
      <Section title="4. Subscription Plans">
        ...
        <Bullet><Strong>Free</Strong> — limited features, 1 Jyotish question/day</Bullet>
        <Bullet><Strong>7-day Free Trial</Strong> — Basic features for new users, one-time only, no payment required</Bullet>
        <Bullet><Strong>Basic</Strong> — ₹199/month or ₹1,799/year, includes 10 Jyotish questions/day and basic analysis</Bullet>
        <Bullet><Strong>Pro</Strong> — ₹399/month or ₹2,999/year, includes unlimited Jyotish questions, full deep analysis, 6-month timeline, karmic insights, PDF reports</Bullet>
      ...
      <Section title="9. Engine-Generated Answers">
        <P>The “Ask” feature uses rule-based and generative analysis of your
        kundli. Jyotish answers are produced by software and may contain errors,
      ...
      <Section title="4. Engine-Generated Content">
        <P>The “Ask” feature uses automated software (rule-based engine) to
