...
export function MarriageCompatProStickyCta({
  isDark,
  canPro,
  loading,
  regularInr,
  ...
  const copy = milanProPurchaseCopy(coerceProPdfLang(lang));
  ...
  return (
    ...
    >
      <View style={s.row}>
        ...
        >
          <LinearGradient
            colors={canPro ? ["#6366f1", "#7c3aed"] : ["#4b5563", "#374151"]}
            start={{ x: 0, y: 0 }}
            end={{ x: 1, y: 0 }}
            style={s.ctaGrad}
          >
...
const s = StyleSheet.create({
  ...
  ctaText: { color: "#fff", fontSize: 12.5, fontFamily: "Nunito_800ExtraBold", textAlign: "center" },
});
