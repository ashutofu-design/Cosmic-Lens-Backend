...
const EN: MoreT = {
  ...
  pk_headerSub: "KP Horary 1-249 · Cuspal Interlinks",
  ...
  pk_qInputPh: "Write your question (optional)…",
...
const HN: Partial<MoreT> = {
  ...
  pk_modeAsk: "Ask Anything",
  pk_modeNumber: "Prashna Kundli",
  pk_initMsg: "🔢 Pranam! Mann ko shant karke 1 se 249 ke beech jo number sabse pehle aaye, woh neeche likhiye. Apna prashna bhi sath mein likh sakte hain (vaikalpik). Wahi sankhya aapki Prashna Kundli ka lagna banegi.",
  ...
  pk_qInputPh: "Apna prashna likhiye (vaikalpik)…",
...
const HI: Partial<MoreT> = {
  ...
  pk_headerSub: "KP होरारी 1-249 · कस्पल इंटरलिंक",
  pk_modeAsk: "कुछ भी पूछें",
  pk_modeNumber: "प्रश्न कुंडली",
  pk_initMsg: "🔢 प्रणाम! शांत मन से 1 से 249 के बीच जो पहली संख्या मन में आए, उसे नीचे लिखें। साथ में अपना प्रश्न भी लिख सकते हैं (वैकल्पिक)। वही संख्या आपकी प्रश्न कुंडली का लग्न बनेगी।",
  ...
  pk_qInputPh: "अपना प्रश्न लिखिए (वैकल्पिक)…",
