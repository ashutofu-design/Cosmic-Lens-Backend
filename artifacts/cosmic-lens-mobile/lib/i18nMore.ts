...
export interface MoreT {
  ...
  settingAbout:        string;
  settingCosmicPacks:  string;
  settingReferEarn:    string;
  settingReferEarnSub: string;
  settingHelp:         string;
  ...
  numBlueprintTitle:  string;
  numPatternTitle:    string;
  ...
  pn_jaapTitle:       string;
  pn_jaapHint:        string;
  pn_jaapPickNaam:    string;
  pn_jaapCustom:      string;
  pn_jaapCustomPh:    string;
  pn_jaapTarget:      string;
  pn_jaapMala:        string;
  pn_jaapUnlimited:   string;
  pn_jaapTap:         string;
  pn_jaapComplete:    string;
  pn_jaapDone:        string;
  pn_jaapMalasDone:   string;
  pn_jaapLeft:        string;
  pn_jaapPause:       string;
  pn_jaapResume:      string;
  pn_jaapUndo:        string;
  pn_jaapReset:       string;
  pn_jaapTip:         string;
...
const EN: MoreT = {
  ...
  settingCosmicPacks: "Cosmic Packs",
  settingReferEarn:   "Refer and Earn",
  settingReferEarnSub:"Share your code · earn rewards",
  ...
  sectionReferEarn:   "REFER AND EARN",
  sectionHelp:        "HELP",
  ...
  numTapHint:         "Tap a card for full traits, strength/weakness & love pattern",
  ...
  numBlueprintTitle:  "WHAT YOUR NUMBERS SAY",
  numPatternTitle:    "HOW YOUR NUMBERS WORK TOGETHER",
  numBasicLockedHint: "Career blueprint, phone numerology & detailed remedies are in your Pro PDF report.",
  ...
  pn_tabJaap:         "Naam Jaap",
  pn_jaapTitle:       "NAAM JAAP TIMER",
  pn_jaapHint:        "Pick a naam, set a mala count, and tap once for each jaap.",
  pn_jaapPickNaam:    "CHOOSE NAAM / MANTRA",
  pn_jaapCustom:      "Custom",
  pn_jaapCustomPh:    "Type your naam or mantra…",
  pn_jaapTarget:      "TARGET COUNT",
  pn_jaapMala:        "Mala",
  pn_jaapUnlimited:   "Unlimited",
  pn_jaapTap:         "Tap · one jaap",
  pn_jaapComplete:    "Mala complete ✨",
  pn_jaapDone:        "Target complete — well done!",
  pn_jaapMalasDone:   "{n} mala complete",
  pn_jaapLeft:        "{n} remaining",
  pn_jaapPause:       "Pause",
  pn_jaapResume:      "Resume",
  pn_jaapUndo:        "Undo",
  pn_jaapReset:       "Reset",
  pn_jaapTip:         "Tip: Brahma Muhurta (before sunrise) is ideal for jaap. Count resets each day.",
  ...
  ab_pMission1: "Cosmic Lens brings Vedic Jyotish into a clear, modern app — classical Parashari principles, precise chart computation, and Cosmic Advance Intelligence so guidance feels personal and practical, in your language.",
  ab_pMission2: "From kundli and dasha to relationships, Vastu, and career questions — our mission is to help you navigate life with clarity, without hype or hidden paywalls.",
  ab_secInside: "What's Inside",
  ab_pInside: "• Ask Cosmic Intelligence V1 — question packs with clear remaining / used counts and expiry\n• Cosmic Intelligence V3 — timed live sessions with a Cosmic Guide\n• LifeMap & Pro reports — Love Reality, Kundli Milan, Numerology, AstroVastu, Business Vastu, and more\n• Daily insights, dashas, and tools for birth charts and compatibility\n• Cosmic Packs — transparent INR pricing via Razorpay; balances and reports in My Reports",
  ab_secDifferent: "What Makes Us Different",
  ab_pDifferent: "• Traditional Lahiri ayanamsa with high-precision Swiss Ephemeris data.\n• Cosmic Advance Intelligence for Ask answers — plus optional V3 live guidance when you want a person.\n• Pack-based value — buy questions or live time when you need them; no surprise subscription traps.\n• Available in many languages including Indian regional languages and Hinglish.\n• Privacy-first — we never sell your kundli or chat data.",
  ...
  ab_linkHelp: "Help & Support",
  ab_linkPacks: "Cosmic Packs",
  ab_linkFounder: "Talk to Founder",
  ...
  da_bb4: "Privacy concern? Email supportcosmiclens@gmail.com.",
  ...
  da_pNeedHelp: "If you have any concern, we'd love to hear from you before you go. Reach us at supportcosmiclens@gmail.com — most issues are resolved within 24 hours.",
  ...
  lg_s1_c: "(c) Generated content — your kundli charts, dashas, compatibility reports, Ask / Cosmic Intelligence history, and saved profiles.",
  lg_s1_d: "(d) Payment information — handled entirely by our payment processor Razorpay. We only store the order ID, product/pack, amount, and success/failure status. We never store card numbers, UPI PINs, CVVs, or banking credentials.",
  ...
  lg_s2_b3: "To provide Cosmic Intelligence answers and V3 live guidance using your kundli data — not your identity for ads.",
  lg_s2_b4: "To process Cosmic Packs and one-time purchases through Razorpay.",
  lg_s2_b5: "To enforce pack question / live-time balances, expiry, and fair-usage rules.",
  ...
  lg_s3_b2: "Razorpay (India) — processes UPI, card, and net-banking transactions. PCI-DSS compliant.",
  ...
  lg_s6_outro: "To exercise any of these rights, email us at supportcosmiclens@gmail.com.",
  ...
  lg_s11_b1: "Email: supportcosmiclens@gmail.com",
  ...
  lg_t3_p: "Cosmic Lens provides Vedic-astrology computations including kundli, dashas, doshas, marriage compatibility, panchang, muhurat, numerology, vastu, lucky elements, Cosmic Intelligence Ask (V1), and V3 live sessions when available. Calculations follow traditional Vedic principles (Lahiri ayanamsa) using accurate ephemeris data.",
  lg_t4_title: "4. Cosmic Packs & Paid Products",
  lg_t4_intro: "Optional products and packs may include:",
  lg_t4_b1: "Cosmic Intelligence V1 question packs (one-time) — stated question count and expiry window",
  lg_t4_b2: "Cosmic Intelligence V3 live session packs — timed live consultation with a Cosmic Guide",
  lg_t4_b3: "One-time LifeMap / Pro reports (e.g. Love Reality Pro, Kundli Milan Pro, Numerology, AstroVastu, Business Vastu)",
  lg_t4_b4: "Where still offered: limited free signup questions or introductory access — details shown before you pay",
  lg_t4_outro: "Prices are shown in INR at checkout. Packs do not auto-renew. Balances, expiry, and report delivery are shown in Ask / Cosmic Packs / My Reports. Manage issues via Help & Support or email support.",
  lg_t5_title: "5. Payments",
  lg_t5_p: "Payments are processed by Razorpay. By making a purchase you agree to Razorpay's terms in addition to ours. All prices are in Indian Rupees (₹) and inclusive of applicable GST.",
  lg_t6_title: "6. Refund Policy",
  lg_t6_p: "Please review our Refund & Cancellation section below for full details. In summary, digital packs and reports are generally final once fulfilled, but refunds may be granted for technical failures, double-charges, or activation failures.",
  ...
  lg_t7_b3: "Use bots, scripts, or automated tools to abuse free questions or pack balances.",
  ...
  lg_t9_title: "9. Cosmic Intelligence Answers",
  lg_t9_p: "Ask V1 answers are produced by Cosmic Advance Intelligence from your kundli and may contain errors, ambiguities, or contradictions. V3 live sessions are timed consultations with a Cosmic Guide when available. They are NOT a substitute for professional advice.",
  ...
  lg_t16_p: "For questions about these Terms, email supportcosmiclens@gmail.com.",
  lg_h_refund: "Refund & Cancellation",
  lg_p_refundIntro: "At Cosmic Lens we want every member to have a great experience. This policy explains when refunds are available for Cosmic Packs and one-time purchases, and how to get help.",
  lg_callout_refund: "Please review the pack or product description (questions, live minutes, expiry, report ETA) before paying. Digital packs and reports are fulfilled as shown in-app after successful payment.",
  lg_r1_title: "1. Cosmic Packs (No Auto-Renewal)",
  lg_r1_intro: "V1 question packs and V3 live packs are one-time purchases — they do not auto-renew:",
  lg_r1_b1: "Check balances and expiry in Ask / Cosmic Packs / My Reports.",
  lg_r1_b2: "Or email supportcosmiclens@gmail.com from your registered email.",
  lg_r1_outro: "Unused questions or live time expire as shown on the pack. Buying a pack does not create a recurring subscription.",
  lg_r2_title: "2. When Refunds Are Granted",
  lg_r2_intro: "We will issue a full or partial refund in these situations:",
  lg_r2_b1: "Double charge / duplicate payment — full refund of the duplicate amount, processed within 5–7 business days.",
  lg_r2_b2: "Payment succeeded but pack/product not activated — full refund or manual activation, your choice.",
  lg_r2_b3: "Technical failure preventing access for more than 72 hours — refund or fix, confirmed by support.",
  lg_r2_b4: "Courtesy cases — clear payment/activation failure on an unused pack (one-time courtesy per user, at our discretion).",
  lg_r3_title: "3. When Refunds Are NOT Granted",
  lg_r3_b1: "Change of mind after pack questions / live time were credited, or a report was delivered.",
  lg_r3_b2: "Astrological prediction did not come true — predictions are interpretive guidance, not guarantees (see Disclaimer).",
  lg_r3_b3: "Pack questions or live minutes were partly or fully used, or the pack expired unused.",
  lg_r3_b4: "Incorrect birth data entered by you.",
  lg_r3_b5: "Refunds for free signup questions (no payment was made).",
  lg_r3_b6: "Refunds requested more than 30 days after payment.",
  lg_r4_title: "4. How to Request a Refund",
  lg_r4_intro: "Email supportcosmiclens@gmail.com with:",
  lg_r4_b1: "Your registered email address or mobile number",
  lg_r4_b2: "The order ID (Help & Support → transactions, or payment confirmation)",
  lg_r4_b3: "Reason for the refund request",
  lg_r4_outro: "We respond to all refund requests within 3 business days. Approved refunds are processed by Razorpay to your original payment method within 5–10 business days.",
  ...
  lg_r6_title: "6. No Pack Auto-Renewal",
  lg_r6_p: "Cosmic Packs and one-time reports do not renew automatically. Buy again only when you choose. If a legacy subscription still exists on an account, cancel via Profile or email support; access continues until the paid period ends.",
  ...
  lg_r8_b1: "Email: supportcosmiclens@gmail.com",
  ...
  lg_d1_p: "Vedic astrology (Jyotish) is an ancient art and philosophical tradition. Interpretations, predictions, dashas, doshas, muhurats, and remedies in Cosmic Lens reflect classical principles plus Cosmic Advance Intelligence and chart computation. They are interpretive and not scientifically verifiable.",
  ...
  lg_d4_title: "4. Cosmic Intelligence & Report Output",
  lg_d4_p: "Ask V1 answers and many report narratives are produced by Cosmic Advance Intelligence from your kundli and may contain errors, omissions, contradictions, or culturally sensitive phrasing. V3 live sessions involve a Cosmic Guide when available. Founder- or expert-reviewed Pro PDFs are guidance, not guaranteed outcomes.",
...
const HN: Partial<MoreT> = {
  ...
  settingCosmicPacks: "Cosmic Packs",
  settingReferEarn:   "Refer and Earn",
  settingReferEarnSub:"Apna code share karo · rewards kamao",
  settingHelp:        "Help & Support",
  ...
  numAutoSynced:      "Auto-synced",
  numFreeSection:     "BASIC NUMEROLOGY",
  numTapHint:         "Poori traits, strength/weakness aur love pattern ke liye card tap karein",
  numLifePathLbl:     "LIFE PATH NUMBER",
  ...
  numBlueprintTitle:  "AAPKE NUMBERS KYA KEHTE HAIN",
  numPatternTitle:    "AAPKE NUMBERS MILKAR KAISE CHALTE HAIN",
  numBasicLockedHint: "Career blueprint, phone numerology aur detailed upay — Pro PDF report mein.",
  numBasicCompareTitle: "BASIC VS PRO",
  ...
  pn_tabJaap:         "Naam Jaap",
  pn_jaapTitle:       "NAAM JAAP TIMER",
  pn_jaapHint:        "Naam chunein, target set karein, har jaap pe ek baar tap karein.",
  pn_jaapPickNaam:    "NAAM / MANTRA CHUNEIN",
  pn_jaapCustom:      "Custom",
  pn_jaapCustomPh:    "Apna naam ya mantra likhein…",
  pn_jaapTarget:      "TARGET COUNT",
  pn_jaapMala:        "Mala",
  pn_jaapUnlimited:   "Unlimited",
  pn_jaapTap:         "Tap · ek jaap",
  pn_jaapComplete:    "Mala poori ✨",
  pn_jaapDone:        "Target complete — shabash!",
  pn_jaapMalasDone:   "{n} mala poori",
  pn_jaapLeft:        "{n} baaki",
  pn_jaapPause:       "Pause",
  pn_jaapResume:      "Resume",
  pn_jaapUndo:        "Undo",
  pn_jaapReset:       "Reset",
  pn_jaapTip:         "Tip: Brahma Muhurta (sunrise se pehle) jaap ke liye uttam. Count har din reset hota hai.",
  ...
  ab_pMission1: "Cosmic Lens Vedic Jyotish ko clear, modern app mein laata hai — classical Parashari principles, precise chart computation, aur Cosmic Advance Intelligence — taaki guidance personal aur practical lage, aapki bhasha mein.",
  ab_pMission2: "Kundli aur dasha se leke relationships, Vastu, aur career sawalon tak — hamara mission hai clarity dena, bina hype aur bina hidden paywalls ke.",
  ab_secInside: "Andar kya hai",
  ab_pInside: "• Ask Cosmic Intelligence V1 — question packs with clear remaining / used counts aur expiry\n• Cosmic Intelligence V3 — timed live sessions Cosmic Guide ke saath\n• LifeMap & Pro reports — Love Reality, Kundli Milan, Numerology, AstroVastu, Business Vastu, aur zyada\n• Daily insights, dashas, birth charts aur compatibility tools\n• Cosmic Packs — transparent INR pricing Razorpay se; balances aur reports My Reports mein",
  ab_secDifferent: "Hum kyun alag hain",
  ab_pDifferent: "• Traditional Lahiri ayanamsa + high-precision Swiss Ephemeris.\n• Ask answers ke liye Cosmic Advance Intelligence — aur optional V3 live jab aapko person chahiye.\n• Pack-based value — jab zarurat ho questions ya live time kharido; surprise subscription traps nahi.\n• Bohot si bhashaon mein — Indian regional languages aur Hinglish shamil.\n• Privacy-first — hum aapki kundli ya chat data kabhi nahi bechte.",
  ...
  da_bb4: "Privacy concern? Email karein supportcosmiclens@gmail.com.",
  ...
  da_pNeedHelp: "Agar koi concern hai, to jaane se pehle hum sun-na chahenge. Reach karein supportcosmiclens@gmail.com — zyadatar issues 24 ghante mein resolve ho jaate hain.",
  ...
  lg_s1_c: "(c) Generated content — aapki kundli charts, dashas, compatibility reports, Ask / Cosmic Intelligence history, aur saved profiles.",
  lg_s1_d: "(d) Payment information — poori tarah hamare payment processor Razorpay ke through handle hoti hai. Hum sirf order ID, product/pack, amount aur success/failure status store karte hain. Hum kabhi card numbers, UPI PINs, CVVs ya banking credentials store nahi karte.",
  ...
  lg_s2_b3: "Cosmic Intelligence answers aur V3 live guidance dene ke liye — ads ke liye aapki identity use nahi.",
  lg_s2_b4: "Razorpay ke through Cosmic Packs aur one-time purchases process karne ke liye.",
  lg_s2_b5: "Pack question / live-time balances, expiry aur fair-usage rules lagaane ke liye.",
  ...
  lg_s3_b2: "Razorpay (India) — UPI, card aur net-banking transactions process karta hai. PCI-DSS compliant.",
  ...
  lg_s6_outro: "In rights ka istemal karne ke liye, supportcosmiclens@gmail.com par email karein.",
  ...
  lg_t3_p: "Cosmic Lens Vedic-astrology computations deta hai jaise kundli, dashas, doshas, vivah compatibility, panchang, muhurat, numerology, vastu, lucky elements, Cosmic Intelligence Ask (V1), aur V3 live sessions jab available ho. Calculations traditional Vedic principles (Lahiri ayanamsa) follow karte hain accurate ephemeris data ke saath.",
  lg_t4_title: "4. Cosmic Packs & Paid Products",
  lg_t4_intro: "Optional products aur packs mein ye ho sakta hai:",
  lg_t4_b1: "Cosmic Intelligence V1 question packs (one-time) — question count aur expiry window",
  lg_t4_b2: "Cosmic Intelligence V3 live session packs — Cosmic Guide ke saath timed live consultation",
  lg_t4_b3: "One-time LifeMap / Pro reports (jaise Love Reality Pro, Kundli Milan Pro, Numerology, AstroVastu, Business Vastu)",
  lg_t4_b4: "Jahan ab bhi offered ho: limited free signup questions ya introductory access — pay se pehle details dikhte hain",
  lg_t4_outro: "Prices checkout par INR mein dikhti hain. Packs auto-renew nahi hote. Balances, expiry aur report delivery Ask / Cosmic Packs / My Reports mein dikhte hain. Issues Help & Support ya email se manage karein.",
  lg_t5_title: "5. Payments",
  lg_t5_p: "Payments Razorpay dwara process hote hain. Purchase karke aap hamari aur Razorpay dono ki terms se sahmat hote ho. Saari prices Indian Rupees (₹) me hain aur applicable GST sahit.",
  lg_t6_title: "6. Refund Policy",
  lg_t6_p: "Poori details ke liye niche Refund & Cancellation section dekhein. Summary me, digital packs aur reports generally final hain jab fulfil ho jaayein, lekin technical failures, double-charges ya activation failures ke liye refunds mil sakte hain.",
  ...
  lg_t7_b3: "Bots, scripts ya automated tools se free questions ya pack balances ka galat istemal karna.",
  ...
  lg_t9_title: "9. Cosmic Intelligence Answers",
  lg_t9_p: "Ask V1 answers Cosmic Advance Intelligence dwara aapki kundli se banaye jaate hain aur unme errors, ambiguities ya contradictions ho sakte hain. V3 live sessions Cosmic Guide ke saath timed consultations hain jab available ho. Ye professional advice ka substitute NAHI hain.",
  ...
  lg_t16_title: "16. Contact",
  lg_t16_p: "In Terms ke baare me sawaalon ke liye, supportcosmiclens@gmail.com par email karein.",
  lg_h_refund: "Refund aur Cancellation",
  lg_p_refundIntro: "Cosmic Lens me hum chahte hain har member ka achha experience ho. Ye policy bataati hai ki Cosmic Packs aur one-time purchases ke liye refunds kab milte hain aur help kaise lein.",
  lg_callout_refund: "Pay karne se pehle pack ya product description (questions, live minutes, expiry, report ETA) zaroor dekhein. Digital packs aur reports successful payment ke baad in-app dikhaye gaye hisaab se fulfil hote hain.",
  lg_r1_title: "1. Cosmic Packs (Auto-Renew nahi)",
  lg_r1_intro: "V1 question packs aur V3 live packs one-time purchases hain — auto-renew nahi hote:",
  lg_r1_b1: "Balances aur expiry Ask / Cosmic Packs / My Reports me check karein.",
  lg_r1_b2: "Ya apni registered email se supportcosmiclens@gmail.com par email karein.",
  lg_r1_outro: "Unused questions ya live time pack par dikhaye expiry ke hisaab se expire hote hain. Pack kharidne se recurring subscription nahi banti.",
  lg_r2_title: "2. Refunds kab milte hain",
  lg_r2_intro: "In situations me hum full ya partial refund denge:",
  lg_r2_b1: "Double charge / duplicate payment — duplicate amount ka full refund, 5–7 business days me process.",
  lg_r2_b2: "Payment successful par pack/product activate nahi hua — full refund ya manual activation, aapki choice.",
  lg_r2_b3: "Technical failure jiski wajah se 72 ghante se zyada access nahi mila — refund ya fix, support confirm karega.",
  lg_r2_b4: "Courtesy cases — unused pack par clear payment/activation failure (per user ek baar, hamari discretion).",
  lg_r3_title: "3. Refunds kab NAHI milte",
  lg_r3_b1: "Pack questions / live time credit hone ya report deliver hone ke baad change of mind.",
  lg_r3_b2: "Astrological prediction sach nahi nikli — predictions interpretive guidance hain, guarantee nahi (Disclaimer dekho).",
  lg_r3_b3: "Pack questions ya live minutes partly/fully use ho gaye, ya pack unused expire ho gaya.",
  lg_r3_b4: "Aapne galat birth data enter kiya.",
  lg_r3_b5: "Free signup questions ke refunds (koi payment hi nahi hua).",
  lg_r3_b6: "Payment ke 30 din se zyada baad refund request.",
  lg_r4_title: "4. Refund Request Kaise Karein",
  lg_r4_intro: "supportcosmiclens@gmail.com par ye saath bhejein:",
  lg_r4_b1: "Aapki registered email address ya mobile number",
  lg_r4_b2: "Order ID (Help & Support → transactions, ya payment confirmation)",
  lg_r4_b3: "Refund request ka reason",
  lg_r4_outro: "Hum saari refund requests ka 3 business days me jawab dete hain. Approved refunds Razorpay dwara aapke original payment method par 5–10 business days me process hote hain.",
  lg_r5_title: "5. Failed Payments",
  ...
  lg_r6_title: "6. Pack Auto-Renew nahi",
  lg_r6_p: "Cosmic Packs aur one-time reports automatically renew nahi hote. Jab chaho tabhi dobara kharido. Agar kisi account par legacy subscription ab bhi active hai, Profile se ya support email se cancel karein; paid period ke end tak access milta rahega.",
  lg_r7_title: "7. Chargebacks",
  ...
  lg_d1_p: "Vedic astrology (Jyotish) ek pracheen kala aur philosophical parampara hai. Cosmic Lens me di gayi interpretations, predictions, dashas, doshas, muhurats aur remedies classical principles plus Cosmic Advance Intelligence aur chart computation ko reflect karti hain. Ye interpretive hain aur scientifically verifiable nahi hain.",
  ...
  lg_d4_title: "4. Cosmic Intelligence & Report Output",
  lg_d4_p: "Ask V1 answers aur kai report narratives Cosmic Advance Intelligence dwara aapki kundli se banaye jaate hain aur unme errors, omissions, contradictions ya culturally sensitive phrasing ho sakti hai. V3 live sessions mein Cosmic Guide shamil ho sakta hai jab available ho. Founder- ya expert-reviewed Pro PDFs guidance hain, guaranteed outcomes nahi.",
...
const HI: Partial<MoreT> = {
  pn_tabJaap:         "नाम जाप",
  pn_jaapTitle:       "नाम जाप टाइमर",
  pn_jaapHint:        "नाम चुनें, लक्ष्य तय करें, और हर जाप पर एक बार टैप करें।",
  pn_jaapPickNaam:    "नाम / मंत्र चुनें",
  pn_jaapCustom:      "कस्टम",
  pn_jaapCustomPh:    "अपना नाम या मंत्र लिखें…",
  pn_jaapTarget:      "लक्ष्य संख्या",
  pn_jaapMala:        "माला",
  pn_jaapUnlimited:   "असीमित",
  pn_jaapTap:         "टैप · एक जाप",
  pn_jaapComplete:    "माला पूर्ण ✨",
  pn_jaapDone:        "लक्ष्य पूरा — साधुवाद!",
  pn_jaapMalasDone:   "{n} माला पूर्ण",
  pn_jaapLeft:        "{n} शेष",
  pn_jaapPause:       "रोकें",
  pn_jaapResume:      "जारी रखें",
  pn_jaapUndo:        "वापस",
  pn_jaapReset:       "रीसेट",
  pn_jaapTip:         "सुझाव: ब्रह्म मुहूर्त (सूर्योदय से पहले) जाप के लिए उत्तम है। गिनती प्रतिदिन रीसेट होती है।",
  ...
  settingCosmicPacks: "Cosmic Packs",
  settingReferEarn:   "रेफ़र और कमाएँ",
  settingReferEarnSub:"अपना कोड शेयर करें · रिवॉर्ड कमाएँ",
  ...
  sectionReferEarn:   "रेफ़र और कमाएँ",
  sectionHelp:        "मदद",
  ...
  numTapHint:         "पूरी विशेषताएं, ताकत/कमज़ोरी और प्रेम पैटर्न के लिए कार्ड टैप करें",
  ...
  numBlueprintTitle:  "आपकी संख्याएं क्या कहती हैं",
  numPatternTitle:    "आपकी संख्याएं मिलकर कैसे काम करती हैं",
  numBasicLockedHint: "करियर ब्लूप्रिंट, फ़ोन न्यूमरोलॉजी और विस्तृत उपाय — प्रो PDF रिपोर्ट में।",
  ...
  ab_pMission1: "Cosmic Lens वैदिक ज्योतिष को एक स्पष्ट, आधुनिक ऐप में लाता है — शास्त्रीय पाराशरी सिद्धांत, सटीक कुंडली गणना, और Cosmic Advance Intelligence — ताकि मार्गदर्शन व्यक्तिगत और व्यावहारिक लगे, आपकी भाषा में।",
  ab_pMission2: "कुंडली और दशा से लेकर रिश्ते, वास्तु और करियर के प्रश्नों तक — हमारा मिशन है स्पष्टता देना, बिना अतिशयोक्ति और बिना छिपे पेवॉल के।",
  ab_secInside: "अंदर क्या है",
  ab_pInside: "• Ask Cosmic Intelligence V1 — प्रश्न पैक, बचे/इस्तेमाल किए गए प्रश्न और expiry के साथ\n• Cosmic Intelligence V3 — Cosmic Guide के साथ समय-बद्ध लाइव सत्र\n• LifeMap और Pro रिपोर्ट्स — Love Reality, Kundli Milan, Numerology, AstroVastu, Business Vastu आदि\n• दैनिक अंतर्दृष्टि, दशा, जन्म कुंडली और compatibility टूल\n• Cosmic Packs — Razorpay से पारदर्शी INR मूल्य; बैलेंस और रिपोर्ट My Reports में",
  ab_secDifferent: "हम क्यों अलग हैं",
  ab_pDifferent: "• पारंपरिक लाहिरी अयनांश + उच्च-परिशुद्धता स्विस एफेमेरिस।\n• Ask उत्तरों के लिए Cosmic Advance Intelligence — और ज़रूरत पर वैकल्पिक V3 लाइव मार्गदर्शन।\n• पैक-आधारित मूल्य — जब ज़रूरत हो प्रश्न या लाइव समय खरीदें; आश्चर्यजनक सब्सक्रिप्शन जाल नहीं।\n• कई भाषाओं में — भारतीय क्षेत्रीय भाषाएँ और हिंग्लिश सहित।\n• गोपनीयता-प्रथम — हम आपकी कुंडली या चैट डेटा कभी नहीं बेचते।",
  ...
  ab_linkHelp: "सहायता और समर्थन",
  ab_linkPacks: "Cosmic Packs",
  ab_linkFounder: "फाउंडर से बात करें",
  ...
  da_bb4: "गोपनीयता चिंता? supportcosmiclens@gmail.com पर ईमेल करें।",
  ...
  da_pNeedHelp: "यदि आपकी कोई चिंता है, तो जाने से पहले हम आपकी बात सुनना चाहेंगे। हमसे supportcosmiclens@gmail.com पर संपर्क करें — अधिकांश समस्याएँ 24 घंटों के भीतर हल हो जाती हैं।",
  ...
  lg_s1_c: "(ग) उत्पन्न सामग्री — आपकी कुंडली चार्ट, दशाएँ, अनुकूलता रिपोर्ट, Ask / Cosmic Intelligence इतिहास, और सहेजी गई प्रोफ़ाइलें।",
  lg_s1_d: "(घ) भुगतान जानकारी — पूरी तरह हमारे भुगतान प्रोसेसर Razorpay द्वारा संभाली जाती है। हम केवल ऑर्डर ID, उत्पाद/पैक, राशि और सफलता/विफलता स्थिति संग्रहीत करते हैं। हम कभी कार्ड नंबर, UPI PIN, CVV या बैंकिंग क्रेडेंशियल संग्रहीत नहीं करते।",
  ...
  lg_s2_b3: "Cosmic Intelligence उत्तर और V3 लाइव मार्गदर्शन देने के लिए — विज्ञापनों के लिए आपकी पहचान नहीं।",
  lg_s2_b4: "Razorpay के माध्यम से Cosmic Packs और एक-बार की खरीदारी संसाधित करने के लिए।",
  lg_s2_b5: "पैक प्रश्न / लाइव-समय बैलेंस, expiry और उचित-उपयोग नियम लागू करने के लिए।",
  ...
  lg_s3_b2: "Razorpay (भारत) — UPI, कार्ड और नेट-बैंकिंग लेनदेन संसाधित करता है। PCI-DSS अनुपालक।",
  ...
  lg_s6_outro: "इनमें से किसी अधिकार का प्रयोग करने के लिए, supportcosmiclens@gmail.com पर ईमेल करें।",
  ...
  lg_s11_b1: "ईमेल: supportcosmiclens@gmail.com",
  ...
  lg_t3_title: "3. सेवा",
  lg_t3_p: "Cosmic Lens वैदिक-ज्योतिष गणनाएँ देता है — कुंडली, दशाएँ, दोष, विवाह अनुकूलता, पंचांग, मुहूर्त, अंक ज्योतिष, वास्तु, शुभ तत्व, Cosmic Intelligence Ask (V1), और उपलब्ध होने पर V3 लाइव सत्र। गणनाएँ पारंपरिक वैदिक सिद्धांतों (लाहिरी अयनांश) का सटीक एफेमेरिस डेटा के साथ पालन करती हैं।",
  lg_t4_title: "4. Cosmic Packs और सशुल्क उत्पाद",
  lg_t4_intro: "वैकल्पिक उत्पाद और पैक में ये शामिल हो सकते हैं:",
  lg_t4_b1: "Cosmic Intelligence V1 प्रश्न पैक (एक-बार) — बताई गई प्रश्न संख्या और expiry अवधि",
  lg_t4_b2: "Cosmic Intelligence V3 लाइव सत्र पैक — Cosmic Guide के साथ समय-बद्ध लाइव परामर्श",
  lg_t4_b3: "एक-बार LifeMap / Pro रिपोर्ट (जैसे Love Reality Pro, Kundli Milan Pro, Numerology, AstroVastu, Business Vastu)",
  lg_t4_b4: "जहाँ अभी भी उपलब्ध हो: सीमित मुफ़्त साइनअप प्रश्न या परिचयात्मक पहुँच — भुगतान से पहले विवरण दिखते हैं",
  lg_t4_outro: "मूल्य चेकआउट पर INR में दिखते हैं। पैक स्वतः नवीनीकृत नहीं होते। बैलेंस, expiry और रिपोर्ट डिलीवरी Ask / Cosmic Packs / My Reports में दिखते हैं। समस्याएँ Help & Support या ईमेल से सुलझाएँ।",
  lg_t5_title: "5. भुगतान",
  lg_t5_p: "भुगतान Razorpay द्वारा संसाधित होते हैं। खरीदारी करके आप हमारी और Razorpay दोनों की शर्तों से सहमत होते हैं। सभी मूल्य भारतीय रुपये (₹) में और लागू GST सहित हैं।",
  lg_t6_title: "6. रिफंड नीति",
  lg_t6_p: "कृपया पूर्ण विवरण के लिए नीचे रिफंड एवं रद्दीकरण अनुभाग देखें। सारांश में, डिजिटल पैक और रिपोर्ट पूर्ण होने के बाद सामान्यतः अंतिम हैं, लेकिन तकनीकी विफलताओं, दोहरे शुल्कों या सक्रियण विफलताओं के लिए रिफंड दिए जा सकते हैं।",
  ...
  lg_t7_b3: "मुफ़्त प्रश्नों या पैक बैलेंस के दुरुपयोग के लिए बॉट्स, स्क्रिप्ट्स या स्वचालित उपकरण।",
  ...
  lg_t9_title: "9. Cosmic Intelligence उत्तर",
  lg_t9_p: "Ask V1 उत्तर Cosmic Advance Intelligence द्वारा आपकी कुंडली से उत्पन्न होते हैं और उनमें त्रुटियाँ, अस्पष्टताएँ या विरोधाभास हो सकते हैं। V3 लाइव सत्र उपलब्ध होने पर Cosmic Guide के साथ समय-बद्ध परामर्श हैं। वे पेशेवर सलाह का विकल्प नहीं हैं।",
  ...
  lg_t16_p: "इन शर्तों के बारे में प्रश्नों के लिए, supportcosmiclens@gmail.com पर ईमेल करें।",
  lg_h_refund: "रिफंड और रद्दीकरण",
  lg_p_refundIntro: "Cosmic Lens में हम चाहते हैं हर सदस्य का अच्छा अनुभव हो। यह नीति बताती है कि Cosmic Packs और एक-बार की खरीदारी के लिए रिफंड कब उपलब्ध हैं और सहायता कैसे लें।",
  lg_callout_refund: "भुगतान से पहले पैक या उत्पाद विवरण (प्रश्न, लाइव मिनट, expiry, रिपोर्ट ETA) अवश्य देखें। डिजिटल पैक और रिपोर्ट सफल भुगतान के बाद ऐप में दिखाए अनुसार पूर्ण होते हैं।",
  lg_r1_title: "1. Cosmic Packs (ऑटो-नवीनीकरण नहीं)",
  lg_r1_intro: "V1 प्रश्न पैक और V3 लाइव पैक एक-बार की खरीदारी हैं — स्वतः नवीनीकृत नहीं होते:",
  lg_r1_b1: "बैलेंस और expiry Ask / Cosmic Packs / My Reports में देखें।",
  lg_r1_b2: "या अपनी पंजीकृत ईमेल से supportcosmiclens@gmail.com पर ईमेल करें।",
  lg_r1_outro: "अप्रयुक्त प्रश्न या लाइव समय पैक पर दिखाए expiry के अनुसार समाप्त होते हैं। पैक खरीदने से आवर्ती सदस्यता नहीं बनती।",
  lg_r2_title: "2. रिफंड कब दिए जाते हैं",
  lg_r2_intro: "इन स्थितियों में हम पूर्ण या आंशिक रिफंड देंगे:",
  lg_r2_b1: "दोहरा शुल्क / डुप्लीकेट भुगतान — डुप्लीकेट राशि का पूर्ण रिफंड, 5–7 कार्य दिवसों में संसाधित।",
  lg_r2_b2: "भुगतान सफल पर पैक/उत्पाद सक्रिय नहीं हुआ — पूर्ण रिफंड या मैन्युअल सक्रियण, आपकी पसंद।",
  lg_r2_b3: "तकनीकी विफलता जो 72 घंटे से अधिक पहुँच रोकती है — रिफंड या सुधार, सहायता पुष्टि करेगी।",
  lg_r2_b4: "सौजन्य मामले — अप्रयुक्त पैक पर स्पष्ट भुगतान/सक्रियण विफलता (प्रति उपयोगकर्ता एक बार, हमारे विवेक पर)।",
  lg_r3_title: "3. रिफंड कब नहीं दिए जाते",
  lg_r3_b1: "पैक प्रश्न / लाइव समय जमा होने या रिपोर्ट डिलीवर होने के बाद विचार बदलना।",
  lg_r3_b2: "ज्योतिषीय भविष्यवाणी सच नहीं हुई — भविष्यवाणियाँ व्याख्यात्मक मार्गदर्शन हैं, गारंटी नहीं (अस्वीकरण देखें)।",
  lg_r3_b3: "पैक प्रश्न या लाइव मिनट आंशिक/पूर्ण उपयोग हो गए, या पैक अप्रयुक्त समाप्त हो गया।",
  lg_r3_b4: "आपने ग़लत जन्म डेटा दर्ज किया।",
  lg_r3_b5: "मुफ़्त साइनअप प्रश्नों के लिए रिफंड (कोई भुगतान नहीं हुआ था)।",
  lg_r3_b6: "भुगतान के 30 दिनों के बाद अनुरोधित रिफंड।",
  lg_r4_title: "4. रिफंड का अनुरोध कैसे करें",
  lg_r4_intro: "supportcosmiclens@gmail.com पर इसके साथ ईमेल करें:",
  lg_r4_b1: "आपका पंजीकृत ईमेल पता या मोबाइल नंबर",
  lg_r4_b2: "ऑर्डर ID (Help & Support → लेनदेन, या भुगतान पुष्टि)",
  lg_r4_b3: "रिफंड अनुरोध का कारण",
  lg_r4_outro: "हम सभी रिफंड अनुरोधों का 3 कार्य दिवसों के भीतर उत्तर देते हैं। स्वीकृत रिफंड Razorpay द्वारा आपकी मूल भुगतान विधि पर 5–10 कार्य दिवसों में संसाधित होते हैं।",
  ...
  lg_r6_title: "6. पैक ऑटो-नवीनीकरण नहीं",
  lg_r6_p: "Cosmic Packs और एक-बार की रिपोर्ट स्वतः नवीनीकृत नहीं होतीं। जब चाहें तभी दोबारा खरीदें। यदि किसी खाते पर पुरानी सदस्यता अभी भी सक्रिय है, तो Profile से या सहायता ईमेल से रद्द करें; सशुल्क अवधि के अंत तक पहुँच बनी रहती है।",
  ...
  lg_r8_b1: "ईमेल: supportcosmiclens@gmail.com",
  ...
  lg_d1_p: "वैदिक ज्योतिष (Jyotish) एक प्राचीन कला और दार्शनिक परंपरा है। Cosmic Lens में दी गई व्याख्याएँ, भविष्यवाणियाँ, दशाएँ, दोष, मुहूर्त और उपाय शास्त्रीय सिद्धांतों तथा Cosmic Advance Intelligence और कुंडली गणना को प्रतिबिंबित करते हैं। ये व्याख्यात्मक हैं और वैज्ञानिक रूप से सत्यापन योग्य नहीं हैं।",
  ...
  lg_d4_title: "4. Cosmic Intelligence और रिपोर्ट आउटपुट",
  lg_d4_p: "Ask V1 उत्तर और कई रिपोर्ट कथाएँ Cosmic Advance Intelligence द्वारा आपकी कुंडली से उत्पन्न होती हैं और उनमें त्रुटियाँ, चूक, विरोधाभास या सांस्कृतिक रूप से संवेदनशील शब्दावली हो सकती है। V3 लाइव सत्रों में उपलब्ध होने पर Cosmic Guide शामिल हो सकता है। संस्थापक- या विशेषज्ञ-समीक्षित Pro PDF मार्गदर्शन हैं, गारंटीकृत परिणाम नहीं।",
  lg_d5_title: "5. उपाय",
