...
- **Health Timing Engine v1.0**: 9-step health-risk timing engine at `event_timing/health/health_engine_v1.py` with medical disclaimers and age guards. Emits a `▸ TIMING ENGINE` health row to `locked_facts.py` and supports remedies.
